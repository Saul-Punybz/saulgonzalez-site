// Site-wide JSON-LD structured data — rendered on the homepage only
export const schema = {
  ...
  '@graph': [
    // ── Person ─────────────────────────────────────────────────────
    {
      ...
      sameAs: [
        ...
        'https://linkedin.com/in/saulgonzalez11',
      ...
      worksFor: {
        ...
        url: 'https://puny.bz',
        description: 'Plataforma SaaS para emprendedores con herramientas digitales simples, rápidas y potenciadas por IA. 1,303 negocios activos en 19 países, 15+ clientes corporativos. La propiedad intelectual proviene de ALQMY Corp (fundada 2018), transferida a Puny.bz en 2024.',
      },
      parent: [
